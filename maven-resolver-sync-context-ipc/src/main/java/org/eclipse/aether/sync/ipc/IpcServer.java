...
public class IpcServer {
    ...
    public static final String NO_FORK_PROP = "aether.syncContext.ipc.nofork";

    public static final String IDLE_TIMEOUT_PROP = "aether.syncContext.ipc.idle.timeout";

    public static final String FAMILY_PROP = "aether.syncContext.ipc.family";

    public static final String NO_NATIVE_PROP = "aether.syncContext.ipc.nonative";

    public static final String STORAGE_PROP = "aether.syncContext.ipc.storage";
