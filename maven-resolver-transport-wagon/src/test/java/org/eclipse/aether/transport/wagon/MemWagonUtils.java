...
class MemWagonUtils {
    ...
    public static Map<String, String> openConnection(
            Wagon wagon, AuthenticationInfo auth, ProxyInfo proxy, Properties headers)
    ...
    private static void verify(String query, String key, String value) throws ConnectionException {
