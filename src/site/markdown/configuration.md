...
`aether.connector.http.maxConnectionsTtl` | long | The maximum TTL (in milliseconds) HTTP client should apply to connections when reused. See <a href="https://hc.apache.org/httpcomponents-client-4.5.x/current/httpclient/apidocs/org/apache/http/conn/ConnectionKeepAliveStrategy.html">ConnectionKeepAliveStrategy</a> for values. | `-1` | yes
