...
`aether.connector.http.supportWebDav` | boolean | If enabled, transport makes it's best to deploy to WebDAV server. Not recommended, better use proper Maven Repository Manager instead. | `false` | yes
