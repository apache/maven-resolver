...
`aether.connector.http.ssl.insecure` | boolean | Using this flag resolver will ignore any kind of certificate validation errors and hostname validation. | `false` | yes
