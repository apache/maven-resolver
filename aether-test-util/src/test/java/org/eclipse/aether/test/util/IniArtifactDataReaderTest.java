...
import org.eclipse.aether.test.util.ArtifactDescription;
import org.eclipse.aether.test.util.IniArtifactDataReader;
...
public class IniArtifactDataReaderTest
{
    ...
    public void setup()
        throws Exception
    {
        this.parser = new IniArtifactDataReader( "org/eclipse/aether/test/util/" );
    }
