 ...
 * A named lock key.
 * <p>
 * Instances of this class immutable, it implements hash/equals and toString method (for easier debug).
 *
 * @since 2.0.0
 */
public final class NamedLockKey {
     ...
     * thing that should be used in implementations of hash/equals, etc.
     */
    public String name() {
        return name;
    }
     ...
     * <p>
     * Contents on this field is consumer project specific, and this string should be used only as
     * "extra information": resolver itself handles these only for logging purposes.
     */
    ...
    public static NamedLockKey of(String name, String... resource) {
        return of(name, Arrays.asList(resource));
    }
