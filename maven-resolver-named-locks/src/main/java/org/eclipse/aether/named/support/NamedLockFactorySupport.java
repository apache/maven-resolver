...
public abstract class NamedLockFactorySupport implements NamedLockFactory {
    ...
    /**
     * Implementation may override this (empty) method to perform some sort of implementation specific cleanup for given
     * lock name. Invoked when reference count for given name drops to zero and named lock was removed.
     */
