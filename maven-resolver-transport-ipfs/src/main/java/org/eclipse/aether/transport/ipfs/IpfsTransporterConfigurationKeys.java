...
public final class IpfsTransporterConfigurationKeys {
    ...
    static final String CONFIG_PROPS_PREFIX =
            ConfigurationProperties.PREFIX_TRANSPORT + IpfsTransporterFactory.NAME + ".";
    ...
    /**
     * Whether to publish IPNS record for deployment.
     *
     * @configurationSource {@link RepositorySystemSession#getConfigProperties()}
     * @configurationType {@link String}
    ...
    public static final boolean DEFAULT_PUBLISH_IPNS = true;
