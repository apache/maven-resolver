...
final class PartialFile implements Closeable {
    ...
    static class LockFile {
        ...
        private static FileLock lock(
                File lockFile, File partFile, int requestTimeout, RemoteAccessChecker checker, AtomicBoolean concurrent)
                throws Exception {
                ...
                for (long lastLength = -1L, lastTime = 0L; ; ) {
                    ...
                    if (currentLength != lastLength) {
                        ...
                        throw new IOException(
                                "Timeout while waiting for concurrent download of " + partFile + " to progress");
                    }
    ...
    static class Factory {
        ...
        public PartialFile newInstance(File dstFile, RemoteAccessChecker checker) throws Exception {
            ...
            File tempFile = File.createTempFile(
                    dstFile.getName() + '-' + UUID.randomUUID().toString().replace("-", ""),
                    ".tmp",
