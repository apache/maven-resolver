...
public class ChecksumCalculatorTest
{
    ...
    {
        ChecksumCalculator calculator = newCalculator( TestChecksumAlgorithmSelector.SHA512, TestChecksumAlgorithmSelector.SHA256, TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
        calculator.init( 0 );
        calculator.update( toBuffer( "Hello World!" ) );
        Map<String, Object> digests = calculator.get();
        assertNotNull( digests );
        assertEquals( "861844d6704e8573fec34d967e20bcfef3d424cf48be04e6dc08f2bd58c729743371015ead891cc3cf1c9d34b49264b510751b1ff9e537937bc46b5d6ff4ecc8", digests.get( TestChecksumAlgorithmSelector.SHA512 ) );
        assertEquals( "7f83b1657ff1fc53b92dc18148a1d65dfc2d4b1fa3d677284addd200126d9069", digests.get( TestChecksumAlgorithmSelector.SHA256 ) );
        assertEquals( "2ef7bde608ce5404e97d5f042f95f89f1c232871", digests.get( TestChecksumAlgorithmSelector.SHA1 ) );
        assertEquals( "ed076287532e86365e841e92bfc50d8c", digests.get( TestChecksumAlgorithmSelector.MD5 ) );
    ...
    public void testWithExcessiveOffset()
    {
        ...
        Map<String, Object> digests = calculator.get();
        assertNotNull( digests );
        assertTrue( digests.get( TestChecksumAlgorithmSelector.SHA512 ) instanceof IOException );
        assertTrue( digests.get( TestChecksumAlgorithmSelector.SHA256 ) instanceof IOException );
        assertTrue( digests.get( TestChecksumAlgorithmSelector.SHA1 ) instanceof IOException );
        assertTrue( digests.get( TestChecksumAlgorithmSelector.MD5 ) instanceof IOException );
        assertEquals( 4, digests.size() );
    }
    ...
    public void testUnknownAlgorithm()
    {
        ...
        newCalculator( "unknown", TestChecksumAlgorithmSelector.SHA1 );
    }
