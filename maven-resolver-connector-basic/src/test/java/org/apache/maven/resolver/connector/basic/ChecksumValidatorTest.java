...
import org.apache.maven.resolver.spi.connector.checksum.ChecksumPolicy;
...
public class ChecksumValidatorTest
{
    ...
    {
        policy = null;
        ChecksumValidator validator = newValidator( TestChecksumAlgorithmSelector.SHA1 );
        validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, "ignored" ), null );
    ...
    {
        ChecksumValidator validator = newValidator( TestChecksumAlgorithmSelector.SHA1 );
        fetcher.mock( TestChecksumAlgorithmSelector.SHA1, "foo" );
        validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, "foo" ), null );
        fetcher.assertFetchedFiles( TestChecksumAlgorithmSelector.SHA1 );
    ...
    public void testValidate_FailOnFirstMismatch()
    {
        ...
        try
        {
            validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, "not-foo" ), null );
        ...
        throws Exception
    {
        ...
        ChecksumValidator validator = newValidator( TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
        fetcher.mock( TestChecksumAlgorithmSelector.SHA1, "foo" );
        fetcher.mock( TestChecksumAlgorithmSelector.MD5, "bar" );
        validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, "foo", TestChecksumAlgorithmSelector.MD5, "bar" ), null );
        fetcher.assertFetchedFiles( TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
    ...
    public void testValidate_FailOnEnd()
    {
        ...
        try
        {
            validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, "not-foo", TestChecksumAlgorithmSelector.MD5, "bar" ), null );
            fail( "expected exception" );
        }
        catch ( ChecksumFailureException e )
        {
        ...
        throws Exception
    {
        ...
        provided.put( TestChecksumAlgorithmSelector.SHA1, "foo" );
        ChecksumValidator validator = newValidator( provided, TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
        fetcher.mock( TestChecksumAlgorithmSelector.SHA1, "foo" );
        fetcher.mock( TestChecksumAlgorithmSelector.MD5, "bar" );
        validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, "foo", TestChecksumAlgorithmSelector.MD5, "bar" ), checksums( TestChecksumAlgorithmSelector.SHA1, "foo", TestChecksumAlgorithmSelector.MD5, "bar" ) );
        fetcher.assertFetchedFiles( TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
        ...
        throws Exception
    {
        ...
        ChecksumValidator validator = newValidator( TestChecksumAlgorithmSelector.SHA1 );
        fetcher.mock( TestChecksumAlgorithmSelector.SHA1, "FOO" );
        validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, "foo" ), checksums( TestChecksumAlgorithmSelector.SHA1, "foo" ) );
        ...
        throws Exception
    {
        ChecksumValidator validator = newValidator( TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
        fetcher.mock( TestChecksumAlgorithmSelector.MD5, "bar" );
        validator.validate( checksums( TestChecksumAlgorithmSelector.MD5, "bar" ), null );
        fetcher.assertFetchedFiles( TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
    ...
    {
        ChecksumValidator validator = newValidator( TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
        fetcher.mock( TestChecksumAlgorithmSelector.SHA1, new IOException( "inaccessible" ) );
        fetcher.mock( TestChecksumAlgorithmSelector.MD5, "bar" );
        validator.validate( checksums( TestChecksumAlgorithmSelector.MD5, "bar" ), null );
        fetcher.assertFetchedFiles( TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
        ...
        throws Exception
    {
        ...
        fetcher.mock( TestChecksumAlgorithmSelector.SHA1, "foo" );
        fetcher.mock( TestChecksumAlgorithmSelector.MD5, "bar" );
        validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, null, TestChecksumAlgorithmSelector.MD5, "bar" ), null );
        fetcher.assertFetchedFiles( TestChecksumAlgorithmSelector.MD5 );
        ...
        throws Exception
    {
        ...
        ChecksumValidator validator = newValidator( TestChecksumAlgorithmSelector.SHA1, TestChecksumAlgorithmSelector.MD5 );
        fetcher.mock( TestChecksumAlgorithmSelector.MD5, "bar" );
        validator.validate( checksums( TestChecksumAlgorithmSelector.SHA1, "foo", TestChecksumAlgorithmSelector.MD5, "bar" ), checksums( TestChecksumAlgorithmSelector.SHA1, "foo" ) );
        assertEquals( 1, fetcher.checksumFiles.size() );
        for ( File file : fetcher.checksumFiles )
        {
            assertTrue( file.getAbsolutePath(), file.isFile() );
