...
public interface RepositoryConnectorFactory {
     ...
     *                   In particular, a connector must notify any
     *                   {@link RepositorySystemSession#getTransferListener()} set for the session and should obey the
     *                   timeouts configured for the session.
