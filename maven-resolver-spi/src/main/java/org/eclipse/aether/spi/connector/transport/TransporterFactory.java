...
public interface TransporterFactory {
     ...
     *
     * @param session    The repository system session from which to configure the transporter, must not be
     *                   {@code null}. In particular, a transporter should obey the timeouts configured for the session.
