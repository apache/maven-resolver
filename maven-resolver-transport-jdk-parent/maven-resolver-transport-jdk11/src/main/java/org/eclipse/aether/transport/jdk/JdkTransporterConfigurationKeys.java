...
public final class JdkTransporterConfigurationKeys {
     ...
     * @deprecated Use {@link ConfigProperties#CONFIG_PROP_HTTP_VERSION} instead. This property is kept for backward compatibility and will be removed in future versions.
     */
    @Deprecated
