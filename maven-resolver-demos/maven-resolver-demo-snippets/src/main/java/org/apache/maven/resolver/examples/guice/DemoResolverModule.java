...
/**
 * Guice module for Demo Resolver snippets. Here, we assemble "complete" module by using {@link AetherModule} (see it's
...
class DemoResolverModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        // AetherModule alone is "ready-made" but incomplete. To have a complete
        // resolver, we
