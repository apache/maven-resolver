...
public class DefaultArtifactResolverTest {
    ...
    @Test
    public void testResolveRemoteSnapshotRegistersNormalizedCopy() throws ArtifactResolutionException {
    ...
    @Test
    public void testResolveCachedFromForeignRepositoryDownloadsByDefault()
    ...
    @Test
    public void testResolveCachedFromForeignRepositoryLegacyExistenceCheck()
            throws IOException, ArtifactResolutionException {
        session.setConfigProperty("aether.artifactResolver.existenceCheckRelabel", true);
