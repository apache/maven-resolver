...
public class GroupIdRemoteRepositoryFilterSourceTest extends RemoteRepositoryFilterSourceTestSupport
{
    ...
    {
        this.repositorySystemSessionLifecycle = new DefaultRepositorySystemSessionLifecycle();
        this.groupIdRemoteRepositoryFilterSource = new GroupIdRemoteRepositoryFilterSource( repositorySystemSessionLifecycle );
                                  ...
                                  Artifact artifact )
    {
        try
        {
            ...
            repositorySystemSessionLifecycle.sessionStarted( newSession );
            groupIdRemoteRepositoryFilterSource.postProcess( newSession, artifactResults );
            repositorySystemSessionLifecycle.sessionEnded( newSession );
        }
        catch ( IOException e )
        {
