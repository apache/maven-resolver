 ...
 */
@Named(NamedLockSyncContextFactory.NAME)
@Priority(-1)
@Singleton
public final class NamedLockSyncContextFactory implements SyncContextFactory, Service {

    public static final String NAME = "named-lock";

    private static final String ADAPTER_KEY = NamedLockSyncContextFactory.class.getName() + ".adapter";
     ...
     */
    @Inject
    public NamedLockSyncContextFactory(NamedLockFactoryAdapterFactory namedLockFactoryAdapterFactory) {
     ...
     */
    @Deprecated
    public NamedLockSyncContextFactory() {
