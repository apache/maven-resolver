...
/**
 * Depth-first {@link org.eclipse.aether.impl.DependencyCollector} (the "original" default). Originally this class was
 * located a package higher (as "default" implementation).
 *
 * @since 1.8.0
 */
@Singleton
