...
public final class UpdateCheck<T, E extends RepositoryException> {
     ...
     *                 {@link #getFile()} does actually not exist, {@link #setException(RepositoryException)} should be
     *                 used to provide the previous/cached failure that explains the absence of the file.
     * @return This object for chaining.
     */
