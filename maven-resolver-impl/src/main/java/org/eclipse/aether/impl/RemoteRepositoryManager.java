...
public interface RemoteRepositoryManager {
     ...
     *
     * @param session               The repository session during which the repositories will be accessed, must not be
     *                              {@code null}.
     ...
     * @param recessiveIsRaw        {@code true} if the recessive repository definitions have not yet been subjected to
