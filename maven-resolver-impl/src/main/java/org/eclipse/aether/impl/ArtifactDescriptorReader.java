...
/**
 * Provides information about an artifact that is relevant to transitive dependency resolution. Each artifact is
 * expected to have an accompanying <em>artifact descriptor</em> that among others lists the direct dependencies of the
 * artifact.
 *
