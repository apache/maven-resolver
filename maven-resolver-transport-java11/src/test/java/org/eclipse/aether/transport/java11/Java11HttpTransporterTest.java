 ...
 *
 */
public class Java11HttpTransporterTest extends HttpTransporterTestSupport
{
    @Override
    protected TransporterFactory newTransporterFactory( RepositorySystemSession session )
    {
        return new Java11HttpTransporterFactory();
    }
    ...
    {
        session.getData().set( Java11HttpTransporter.HTTP_INSTANCE_KEY_PREFIX + repository.getId(), null );
    ...
    {
        throw new IllegalStateException( "webDAV is not supported" );
    }
    ...
    public void testClassify()
    {
        ...
        assertEquals( Transporter.ERROR_OTHER, transporter.classify( new Java11HttpException( 403 ) ) );
        assertEquals( Transporter.ERROR_NOT_FOUND, transporter.classify( new Java11HttpException( 404 ) ) );
    }
}
