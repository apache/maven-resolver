...
/**
 * A transporter factory for repositories using the {@code http:} or {@code https:} protocol backed by Java 11+
 * HttpClient.
 *
 * @since TBD
 */
@Named( "java11" )
public final class Java11HttpTransporterFactory
        implements TransporterFactory
{
     ...
     */
    public Java11HttpTransporterFactory setPriority( float priority )
    {
            ...
            throws NoTransporterException
    {
        ...
        return new Java11HttpTransporter( session, repository );
    }
}
