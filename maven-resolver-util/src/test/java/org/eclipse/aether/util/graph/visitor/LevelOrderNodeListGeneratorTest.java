...
public class LevelOrderNodeListGeneratorTest {
    ...
    public void testOrdering() throws Exception {
        ...
        LevelOrderNodeListGenerator visitor = new LevelOrderNodeListGenerator();
        root.accept(visitor);

        assertSequence(visitor.getNodes(), "a", "b", "d", "c", "e");
    }
