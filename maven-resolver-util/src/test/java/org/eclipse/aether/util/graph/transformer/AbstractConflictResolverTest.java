...
public abstract class AbstractConflictResolverTest {
    ...
    protected DependencyNode transform(ConflictResolver conflictResolver, DependencyNode root)
    ...
    protected void setVerbosity(ConflictResolver.Verbosity verbosity) {
