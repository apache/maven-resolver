 ...
 * "beta" = "b" &lt; "milestone" = "m" &lt; "preview" &lt; "rc" = "cr" &lt; "dev" = "snapshot" &lt; "final" = "ga" &lt;
 * "sp". All of those well-known qualifiers are considered smaller/older than other strings. An empty segment/string is
 * equivalent to 0.
 * </p>
 * <p>
