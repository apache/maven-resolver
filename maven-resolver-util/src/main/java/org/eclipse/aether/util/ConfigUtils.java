...
public final class ConfigUtils {
     ...
     * @param keys         The property keys to read, must not be {@code null}. The specified keys are read one after
     *                     one until a valid value is found.
     ...
     *                     {@code null}.
     * @param keys         The property keys to read, must not be {@code null}. The specified keys are read one after
     *                     one until a string value is found.
     * @return The property value or {@code null} if none.
     */
     ...
     * @param keys         The property keys to read, must not be {@code null}. The specified keys are read one after
     *                     one until a {@link Number} or a string representation of an {@link Integer} is found.
     ...
     * @param defaultValue The default value to return in case none of the property keys is set to a number.
     * @param keys         The property keys to read, must not be {@code null}. The specified keys are read one after
     *                     one until a {@link Number} or a string representation of a {@link Long} is found.
     * @return The property value.
     */
     ...
     * @param defaultValue The default value to return in case none of the property keys is set to a number.
     * @param keys         The property keys to read, must not be {@code null}. The specified keys are read one after
     *                     one until a {@link Number} or a string representation of a {@link Float} is found.
     * @return The property value.
     */
     ...
     * @param keys         The property keys to read, must not be {@code null}. The specified keys are read one after
     *                     one until a {@link Boolean} or a string (to be {@link Boolean#parseBoolean(String) parsed as
     *                     boolean}) is found.
     * @return The property value.
     */
     ...
     * @param keys         The property keys to read, must not be {@code null}. The specified keys are read one after
     *                     one until a collection is found.
     * @return The property value or {@code null} if none.
     */
