 ...
 * up the proxy configuration from the operating system, see
 * <a href= "http://docs.oracle.com/javase/6/docs/technotes/guides/net/proxies.html">Java Networking and Proxies</a> for
...
public final class JreProxySelector implements ProxySelector {
    ...
    public Proxy getProxy(RemoteRepository repository) {
        ...
        try {
            ...
            // URL invalid or not accepted by selector or no selector at all, simply use no
            // proxy
        }
        if (proxies != null) {
